...
//                     <Card.Meta title={product.product_name} description={Number(product.discount) > 0 ?
//                         <div className="product-description">
//                             <span className="product-price">
//                                 <span className="discounted-price">${product.discounted_price}</span>
//                                 <span className="discounted-price" style={{ textDecoration: 'line-through', color: 'grey', padding: "0 5px", fontSize: "12px" }}>${product.original_price}</span>
//                             </span>
