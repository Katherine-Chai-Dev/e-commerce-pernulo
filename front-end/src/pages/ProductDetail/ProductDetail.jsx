...
const getLocalImage = (url, size) => {
    if (!url) return url;
    const filename = url.split('/').pop().replace('.png', '.webp');
    return `/product-images/${size}-webp/${filename}`;
};
                    ...
                    <div className="gallery-container">
                        <div className="main-image-container">
                            <div className="image-wrapper">
                                <img
                                    src={getLocalImage(product?.image_paths[selectedIndex], 800)}
