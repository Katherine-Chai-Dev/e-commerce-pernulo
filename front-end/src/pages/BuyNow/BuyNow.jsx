...
import '../Cart/Cart.css';
import { Layout, Card, Button, Empty, Divider, Spin } from 'antd';
import { DeleteOutlined, ShoppingOutlined, ArrowLeftOutlined, PlusOutlined, MinusOutlined } from '@ant-design/icons';
...
const BuyNow = () => {
    ...
    // Get the product from navigation state
    const [buyNowItem, setBuyNowItem] = useState(null);

    useEffect(() => {
        // Get product from location state (passed from product detail page)
    ...
    const handleCheckout = () => {
        if (user) {
            // Pass the buyNowItem to checkout, not cart items
            navigate('/checkout', { 
                state: { 
    ...
    // Show loading or empty state if no item
    if (!buyNowItem) {
        return (
            <Layout.Content className="cart-content">
                <div className="cart-container">
